...
namespace UI.Controllers
{
    ...
    {
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/Spring/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/Spring/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/Spring/GiveMoney";
        private const string str_a_activityname = "【蜀乐池温泉休闲中心红包雨】";
        private const string str_b_activityname = "【蜀乐池温泉休闲中心红包雨】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【蜀乐池温泉休闲中心红包雨】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【蜀乐池温泉休闲中心红包雨】-实物已领取";
        private const string str_e_activityname = "【蜀乐池温泉休闲中心红包雨】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【蜀乐池温泉休闲中心红包雨】-取奖品awardsModel.Class == null";

        private const string activityName = "【蜀乐池温泉休闲中心现金红包】";
        private const string TenPaySender = "蜀乐池温泉休闲中心";
        private const string TenPayWish = "恭喜发财";
        private const string TenPayGame = "蜀乐池温泉休闲中心，红包雨";
        private const string TenPayRemark = "蜀乐池温泉休闲中心";

        //100元门票  100元SPA   50元足浴    全价体验票   笔记本   杯垫
