...
{
    public class CommerceCityController : BaseController
    {

        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/CommerceCity/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/CommerceCity/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/CommerceCity/GiveMoney";
        private const string str_a_activityname = "【商业城红包雨】";
        private const string str_b_activityname = "【商业城红包雨】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【商业城红包雨】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【商业城红包雨】-实物已领取";
        private const string str_e_activityname = "【商业城红包雨】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【商业城红包雨】-取奖品awardsModel.Class == null";

        private const string activityName = "【商业城现金红包】";
        private const string TenPaySender = "商业城";
        private const string TenPayWish = "恭喜发财";
        private const string TenPayGame = "商业城，红包雨";
        private const string TenPayRemark = "商业城";
