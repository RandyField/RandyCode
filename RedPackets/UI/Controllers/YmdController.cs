...
{
    public class YmdController : BaseController
    {

        #region 单人微信 限领取一次

        #endregion
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/Ymd/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/Ymd/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/Ymd/GiveMoney";
        private const string str_a_activityname = "【辽宁省公安厅交通安全管理局红包雨】";
        private const string str_b_activityname = "【辽宁省公安厅交通安全管理局红包雨】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【辽宁省公安厅交通安全管理局红包雨】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【辽宁省公安厅交通安全管理局红包雨】-实物已领取";
        private const string str_e_activityname = "【辽宁省公安厅交通安全管理局红包雨】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【辽宁省公安厅交通安全管理局红包雨】-取奖品awardsModel.Class == null";

        private const string activityName = "【辽宁省公安厅交通安全管理局红包雨】";
        private const string TenPaySender = "辽宁省公安厅交通安全管理局";
        private const string TenPayWish = "交通知识";
        private const string TenPayGame = "辽宁省公安厅交通安全管理局，红包雨";
        private const string TenPayRemark = "亚马达";
