...
{
    public class DoubleElevenController : BaseController
    {
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/DoubleEleven/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/DoubleEleven/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/DoubleEleven/GiveMoney";
        private const string str_a_activityname = "【京东双十一】";
        //private const string str_b_activityname = "【京东双十一】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【京东双十一】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【京东双十一】-实物已领取";
        private const string str_e_activityname = "【京东双十一】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【京东双十一】-取奖品awardsModel.Class == null";
        ...
        Dictionary<string, string> dic_url = new Dictionary<string, string>(){
                    {"108减8","http://coupon.m.jd.com/coupons/show.action?key=9fcc48ef596a4c34b1bc8da8aebe2ac3&roleId=8825843&to=wq.jd.com/mcoss/wxportal/mainentry?tpl=index_v5&PTAG=17067.7.1&ptype=1"},
                    {"199减15","http://coupon.m.jd.com/coupons/show.action?key=7aee26083a4e43878b2a73a53df38cbd&roleId=8825844&to=wq.jd.com/mcoss/wxportal/mainentry?tpl=index_v5&PTAG=17067.7.1&ptype=1"},
                    {"399减20","http://coupon.m.jd.com/coupons/show.action?key=3f1a6931a95e488888743a0b3cfe89d6&roleId=8825842&to=wq.jd.com/mcoss/wxportal/mainentry?tpl=index_v5&PTAG=17067.7.1&ptype=1"}
         };
        ...
        public ActionResult Activity(string activityId, string awardid, string awardname)
        {
            ...
            if (string.IsNullOrWhiteSpace(awardid))
            {
                ...
                scanCountDi.getBll().CountByNameAndId(activityId, string.Format("【京东双十一】-flash端网络异常, 跳转券-【{0}】",awardname));
                return empty;
            }
        ...
        public ActionResult WXActivity(RequestModel request)
        {
            ...
            try
            {
                ...
                if (awardsModel.Class.Contains("减"))
                {
                    ...
                    scanCountDi.getBll().CountByNameAndId(request.activityId, string.Format("【京东双十一】-游戏正常, 跳转券-【{0}】", awardsModel.Class.Trim()));
                    return empty;
                }
