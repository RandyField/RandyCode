...
{
    public class ConundrumController : BaseController
    {
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/Conundrum/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/Conundrum/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/Conundrum/GiveMoney";
        private const string str_a_activityname = "【正月十五猜灯谜-其他站】";
        private const string str_b_activityname = "【正月十五猜灯谜-其他站】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【正月十五猜灯谜-其他站】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【正月十五猜灯谜-其他站】-实物已领取";
        private const string str_e_activityname = "【正月十五猜灯谜-其他站】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【正月十五猜灯谜-其他站】-取奖品awardsModel.Class == null";
