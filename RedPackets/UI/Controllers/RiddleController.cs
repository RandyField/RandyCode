...
{
    public class RiddleController : BaseController
    {
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/Riddle/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/Riddle/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/Riddle/GiveMoney";
        private const string str_a_activityname = "【正月十五猜灯谜-中街站】";
        private const string str_b_activityname = "【正月十五猜灯谜-中街站】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【正月十五猜灯谜-中街站】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【正月十五猜灯谜-中街站】-实物已领取";
        private const string str_e_activityname = "【正月十五猜灯谜-中街站】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【正月十五猜灯谜-中街站】-取奖品awardsModel.Class == null";
        ...
        public ActionResult WXActivity(RequestModel request)
        {
            ...
            try
            {
                ...
                #region +中街站 限定5次领奖机会（即大于等于6）


                if (isAttendToday(request.activityId, wxUser.Openid, 5))
                {
                    //判断最新奖品是否已领
                ...
                else
                {
                    ...
                    if (awardsModel.Class != null)
                    {
                        ...
                        else
                        {
                            ...
                            entity.Description = string.Format("{0},用户在{1}点击红包，二维码扫码进入实物领奖页面，奖品为{1}",
                                                                    str_a_activityname,
                                                                    DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), awardsType);
