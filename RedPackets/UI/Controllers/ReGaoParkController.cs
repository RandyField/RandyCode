...
{
    public class ReGaoParkController : BaseController
    {
        /// <summary>
        ///  ViewData["Openid"] = "";
        ...
        public ActionResult Activity(string activityId, string flag, string guid)
        {
            ...
            try
            {
                ...
                entity.Enable = true;
                entity.PageUrl = HttpContext.Request.Url.AbsoluteUri ?? "http://www.chinazhihuiping.com/wxredpackets/ReGaoPark/Activity";
                ...
                if (awardsModel.Class != null)
                {
                    ...
                    {
                        //非卡重定向 至微信领奖页
                        string url = string.Format("http://www.chinazhihuiping.com/wxredpackets/ReGaoPark/WXActivity?activityId={0}&giftType={1}&giftId={2}", activityId, awardsModel.Class, awardsModel.id);
        ...
        /// <param name="activityId"></param>
        /// <returns></returns>
        public ActionResult Cash(string activityId)
        {
            ActionResult empty = new EmptyResult();
            try
            {
