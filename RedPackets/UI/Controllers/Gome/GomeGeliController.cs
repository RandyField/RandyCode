...
{
    public class GomeGeliController : BaseController
    {
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/GomeGeli/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/GomeGeli/WXActivity";
        //private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/GomeGeli/GiveMoney";
        private const string str_a_activityname = "【国美格力促销红包雨】";
        private const string str_b_activityname = "【国美格力促销红包雨】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【国美格力促销红包雨】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【国美格力促销红包雨】-实物已领取";
        private const string str_e_activityname = "【国美格力促销红包雨】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【国美格力促销红包雨】-取奖品awardsModel.Class == null";
