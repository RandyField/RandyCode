...
{
    public class WawaController : BaseController
    {
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/Wawa/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/Wawa/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/Wawa/GiveMoney";
        private const string str_a_activityname = "【沈阳抓娃娃互动游戏】";
        //private const string str_b_activityname = "【京东双十一】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【沈阳抓娃娃互动游戏】-发生重定向-实物红包跳转";
        private const string str_d_activityname = "【沈阳抓娃娃互动游戏】-实物已领取";
        private const string str_e_activityname = "【沈阳抓娃娃互动游戏】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【沈阳抓娃娃互动游戏】-取奖品awardsModel.Class == null";
        ...
        public ActionResult Activity(string activityId, string awardid, string awardname)
        {
            ...
            {
                scanCountDi.getBll().CountByNameAndId(activityId, string.Format("【沈阳抓娃娃互动游戏】-flash端网络异常-【{0}】", awardname));
                return View("Nogift");
            }
