...
{
    public class SyylcController : BaseController
    {
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/Syylc/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/Syylc/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/Syylc/GiveMoney";
        private const string str_a_activityname = "【川味中国一条街盛大开业】";
        private const string str_b_activityname = "【川味中国一条街盛大开业】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【川味中国一条街盛大开业】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【川味中国一条街盛大开业】-实物已领取";
        private const string str_e_activityname = "【川味中国一条街盛大开业】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【川味中国一条街盛大开业】-取奖品awardsModel.Class == null";

        private const string activityName = "【豫珑城圣诞节】";
        private const string TenPaySender = "豫珑城";
        private const string TenPayWish = "恭喜发财";
        private const string TenPayGame = "豫珑城圣诞节，红包雨";
        private const string TenPayRemark = "豫珑城圣诞节";
