...
{
    public class DragonBoatController : BaseController
    {
        #region 单人微信 限领取一次

        #endregion
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/DragonBoat/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/DragonBoat/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/DragonBoat/GiveMoney";
        private const string str_a_activityname = "【豫珑城2018端午节红包雨】";
        private const string str_b_activityname = "【豫珑城2018端午节红包雨】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【豫珑城2018端午节红包雨】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【豫珑城2018端午节红包雨】-实物已领取";
        private const string str_e_activityname = "【豫珑城2018端午节红包雨】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【豫珑城2018端午节红包雨】-取奖品awardsModel.Class == null";
