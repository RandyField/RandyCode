...
{
    public class ZTECityController : BaseController
    {
        private const string enter_url = "http://www.chinazhihuiping.com/wxredpackets/ZTECity/Activity";
        private const string wx_url = "http://www.chinazhihuiping.com/wxredpackets/ZTECity/WXActivity";
        private const string money_url = "http://www.chinazhihuiping.com/wxredpackets/ZTECity/GiveMoney";
        private const string str_a_activityname = "【中兴大厦红包雨】";
        private const string str_b_activityname = "【中兴大厦红包雨】发生重定向-现金红包跳转";
        private const string str_c_activityname = "【中兴大厦红包雨】发生重定向-实物红包跳转";
        private const string str_d_activityname = "【中兴大厦红包雨】-实物已领取";
        private const string str_e_activityname = "【中兴大厦红包雨】-取奖品awardsModel.Class == \"\"";
        private const string str_f_activityname = "【中兴大厦红包雨】-取奖品awardsModel.Class == null";

        private const string activityName = "【中兴大厦现金红包】";
        private const string TenPaySender = "中兴大厦";
        private const string TenPayWish = "恭喜发财";
        private const string TenPayGame = "中兴大厦，红包雨";
        private const string TenPayRemark = "中兴大厦";
